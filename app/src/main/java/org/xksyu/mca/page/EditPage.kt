...
fun AddConfigList(temp : AlarmTemp, isEdit : Boolean, alarmById: AlarmData?){
    val weekName = arrayOf(stringResource(R.string.dayOfWeek_1),stringResource(R.string.dayOfWeek_2),stringResource(
        R.string.dayOfWeek_3),stringResource(R.string.dayOfWeek_4),stringResource(R.string.dayOfWeek_5),stringResource(
        R.string.dayOfWeek_6),stringResource(R.string.dayOfWeek_7))
